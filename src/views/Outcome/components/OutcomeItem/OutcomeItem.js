            ...
            >
              <FormGroup>
                ...
                <RadioGroup
                  className={classes.field}
                  row
                  value={desfecho.tipo_autocuidado && desfecho.tipo_autocuidado.id.toString() || ''}
                >
        ...
        >
          <FormGroup>
            ...
            <RadioGroup
              className={classes.field}
              row
              value={desfecho.tipo_cuidado_paliativo && desfecho.tipo_cuidado_paliativo.id.toString() || ''}
            >
